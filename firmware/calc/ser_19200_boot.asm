;;;
;;; simple 19200-baud binary loader
;;; (for 16MHz CPU clock)
;;;
;;; on reset, waits ~ 10s for serial load
;;; then, tries to load image from flash
;;; 
...
;;; if header not seen after a few bytes, bail out to start
;;;
